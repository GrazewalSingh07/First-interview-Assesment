...
export const DefaultBoxes=()=>{
    ...
    <div style={{display:"flex",justifyContent:"space-around" }}>
        ...
        <Input value= "alert 1" style={{width:"10%", height:"2.2rem"}}/>
        ...
        <Input type="number"defaultValue="10" placeholder="min" style={{width:"3rem", padding:"7px",margin:".2rem"}}/>
    ...
    <Select mode="multiple" style={{ width: '40%', }} placeholder="Select..."
            defaultValue={['ME Totge (Avg.)','ME Speed (Avg.)','Rate of Return (Avg.)']}
            onChange={handleChange}
            optionLabelProp="label" >
            <Option value="ME Totge (Avg.)" label="ME Totge (Avg.)">
            <div className="demo-option-label-item">
